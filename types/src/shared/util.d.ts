...
export namespace AnnotationEditorParamsType {
    ...
    let SQUARE_COLOR: number;
    let SQUARE_OPACITY: number;
    let TEXT_COLOR: number;
}
...
export namespace AnnotationEditorType {
    ...
    export let INK: number;
    export let TEXT: number;
    export let LINK_NODE: number;
}
...
export namespace AnnotationType {
    ...
    let UNDERLINE_2: number;
    export { UNDERLINE_2 as UNDERLINE };
    export let SQUIGGLY: number;
    let STRIKEOUT_1: number;
    export { STRIKEOUT_1 as STRIKEOUT };
    let STAMP_1: number;
