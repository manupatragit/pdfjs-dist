...
export class AnnotationEditorLayer {
    ...
    static #editorTypes: Map<number, typeof FreeTextEditor | typeof HighlightEditor | typeof InkEditor | typeof SquareEditor | typeof StampEditor | typeof TextEditor>;
    /**
     ...
     * @param {number} mode
     */
    updateModeAndToolbar(mode: number): void;
    /**
     * The mode has changed: it must be updated.
     * @param {number} mode
     */
    updateMode(mode?: number): void;
    afterAnnotationsLoaded(): void;
    afterLinkNodesLoaded(): void;
    addInkEditorIfNeeded(isCommitting: any): void;
    addSquareEditorIfNeeded(isCommitting: any): void;
    /**
     ...
     * @param {Object} params
     */
    addCommands(params: Object, editor: any): void;
    ...
    enableTextSelection(selectionMode?: string): void;
     ...
     * @param {AnnotationEditor} editor
     */
    add(editor: AnnotationEditor, isTempHighlight?: boolean): void;
    ...
    deserializeFromJSON(data: any): any;
    deserializeLinkNode(data: any): AnnotationEditor | null;
    /**
    ...
    removeTempHighlight(): void;
    addTempHighlight(event: any, data: any): void;
    createLinkNode(targetId: any): void;
    createAnnotationNode({ color, type, }?: {
        color?: null | undefined;
        type?: number | undefined;
    }): void;
    get hasTempHighlight(): boolean;
    /**
     ...
     * @param {RenderEditorLayerOptions} parameters
     */
    update({ viewport, textLayer }: RenderEditorLayerOptions): void;
    /**
     * Get page dimensions.
